        ...
        <div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-3">
          {PROJECTS.map((project) => (
            ...
            >
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 bg-gradient-to-br from-tan/30 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"
              />
              <p className="font-mono text-[10px] tracking-[0.2em] text-accent">{project.tag}</p>
